        ...
        <div class="sidebar_main_header">
            <div class="sidebar_logo">
                <a href="<?php echo base_url()."pg_admin/dashboard/" ?>" class="sSidebar_hide sidebar_logo_large">
                    <img class="logo_regular" src="<?php echo asset_url('pg_admin/assets/img/logo.png');?>" alt="" />
                ...
                <a href="<?php echo base_url()."pg_admin/dashboard/" ?>" class="sSidebar_show sidebar_logo_small">
                    <img class="logo_regular" src="<?php echo asset_url('pg_admin/assets/img/logo.png');?>" alt="" height="32" width="32"/>
