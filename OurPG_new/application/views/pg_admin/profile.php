            ...
            <div class="uk-form-row">
                <div class="uk-grid">
                    <div class="uk-width-medium-1-1">
                        <div class="md-input-wrapper"><label>Old Password<span style="color:red">*</span></label><input type="password" class="md-input old_password"><span class="md-input-bar"></span></div>
                    </div>
                </div>
            </div>
            <div class="uk-form-row">
                <div class="uk-grid">
                    <div class="uk-width-medium-1-1">
                        <div class="md-input-wrapper"><label>New Password<span style="color:red">*</span></label><input type="password" class="md-input new_password"><span class="md-input-bar"></span></div>
                    </div>
            ...
            <div class="uk-form-row">
                <div class="uk-grid">
                    <div class="uk-width-medium">
                        <div class="md-input-wrapper"><label>Confirm New Password<span style="color:red">*</span></label><input type="password" class="md-input confirm_new_password"><span class="md-input-bar"></span></div>
                    </div>
                </div>
            </div>
