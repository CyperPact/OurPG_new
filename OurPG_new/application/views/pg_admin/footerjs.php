            ...
            <div class="uk-form-row">
                <div class="uk-grid">
                    <div class="uk-width-medium-1-1">
						...
						<input type="password" class="md-input old_password" name="password"><span class="md-input-bar"></span></div>
                    </div>
                </div>
            </div>
            <div class="uk-form-row">
                <div class="uk-grid">
                    <div class="uk-width-medium-1-1">
						...
						<input type="password" name="new_password" id="epasscheck" class="md-input new_password"><span class="md-input-bar"></span></div>
                    </div>
            ...
            <div class="uk-form-row">
                <div class="uk-grid">
                    <div class="uk-width-medium">
						...
						<input type="password" name="confirm_password" class="md-input confirm_new_password"><span class="md-input-bar"></span></div>
                    </div>
                </div>
            </div>
