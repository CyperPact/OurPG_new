...
<head>
    ...
    <!-- uikit -->
    <link rel="stylesheet" href="<?php echo asset_url('pg_admin/bower_components/uikit/css/uikit.almost-flat.min.css') ?>"/>

    <!-- altair admin login page -->
    <link rel="stylesheet" href="<?php echo asset_url('pg_admin/assets/css/login_page.min.css'); ?>" />
