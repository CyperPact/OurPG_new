                    ...
                    <form class="uk-form-stacked" id="wizard_advanced_form" action="<?php echo base_url().'guestregister/guestregistration' ?>" name="wizard_advanced_form" method="post">
                        <div id="wizard_advanced">
                            ...
                            <section>
                                ...
                                <span class="uk-alert uk-alert-info"> <input type="checkbox" required name="agree" id="d_form_phone{{ counter }}" data-switchery /> <a href="<?php echo base_url().'content/terms_conditions' ?>">By clicking here you agree to Term & Condition</a></span>                              
                            </section>
