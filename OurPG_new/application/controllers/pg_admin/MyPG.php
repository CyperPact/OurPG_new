...
class MyPG extends CI_Controller {
        ...
        public function addemployeedetail() {
            ...
            } else if($role == ROLE_PG_CARETAKER)
            {
                ...
                $op['status']="success";
                $op['msg'] = "Caretaker added sucessfully Employee Code:".$company_employee_id;                          
            }
	...
	function deletePG($id) {			
		$this->pgadmin->delete_info('my_pgs','mypg_id',$id);
